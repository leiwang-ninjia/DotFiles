...
function! SpaceVim#plug#begin(path) abort
...
function! SpaceVim#plug#end() abort
    if g:spacevim_plugin_manager ==# 'neobundle'
        call neobundle#end()
...
function! SpaceVim#plug#defind_hooks(bundle) abort
    if g:spacevim_plugin_manager ==# 'neobundle'
...
function! SpaceVim#plug#fetch() abort
    if g:spacevim_plugin_manager ==# 'neobundle'
...
function! SpaceVim#plug#add(repo,...) abort
...
function! SpaceVim#plug#tap(plugin) abort
    if g:spacevim_plugin_manager ==# 'neobundle'
...
function! SpaceVim#plug#enable_plug() abort
...
function! SpaceVim#plug#loadPluginBefore(plugin) abort
